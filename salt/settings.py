...
INSTALLED_APPS = (
    ...
    'django_crontab',
    'salt', 'camo', 'pdt', 'sms', 'ato', 'panel', 'fin', 'fbo', 'res',
)
...
EMAIL_ATO = ['ato@salt.aero', 'm.gradek@salt.aero ', 'm.malec@salt.aero']
...
CRONJOBS = [
    ('0  7 * * 1-5', 'res.views.PortSend'),
    ('0 15 * * 5  ', 'res.views.PortSendWeekend'),
